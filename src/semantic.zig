...
//     defer ast.statements.deinit();
//
//     var expr = Expr{ .Variable = .{
//         .name = Token{ .type = TokenType.Identifier, .lexeme = "x", .line = 1 },
//     } };
//     const stmt = Stmt{ .Expression = .{ .expression = &expr } };
